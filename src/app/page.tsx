        ...
        <div className="flex items-center justify-center">
          <span className="relative flex shrink-0 overflow-hidden rounded-full">
            <span className="flex h-48 w-48 items-center justify-center rounded-full bg-muted">
              <img src="https://private-user-images.githubusercontent.com/46696111/298399529-51be73ef-903f-46bc-9dac-58db4c0426b0.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..JOeetrEQ9j0zIHBW_MODecadd7W-Lb2vPYGpsozmNFw"
                alt="Avatar"
              />
            </span>
          </span>
